...
function AddCourses() {
    ...
    const [frontendImage, setFrontendImage] = useState(img);  // Default image fallback
        ...
        <div className="max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md">
            ...
            <div className="flex items-center justify-center gap-[20px] md:justify-between flex-col md:flex-row  mb-6 relative">
                ...
                <div className="space-x-2 space-y-2 ">
                    <button className="bg-black text-white px-4 py-2 rounded-md" type="button" onClick={() => navigate(`/createlecture/${selectedCourse?._id}`)}>Go to lectures page</button>
                </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-md">
                ...
                <div className="space-x-2 space-y-2 ">
                    {!isPublished ?
                        <button className="bg-green-100 text-green-600 px-4 py-2 rounded-md border-1" type="button" onClick={() => setIsPublished(prev => !prev)}>Click to Publish</button>
                        :
                        <button className="bg-red-100 text-red-600 px-4 py-2 rounded-md border-1" type="button" onClick={() => setIsPublished(prev => !prev)}>Click to UnPublish</button>
                    }
                    <button className="bg-red-600 text-white px-4 py-2 rounded-md" disabled={loading1} type="button" onClick={removeCourse}>{loading1 ? <ClipLoader size={30} color='white' /> : "Remove Course"}</button>
                </div>
