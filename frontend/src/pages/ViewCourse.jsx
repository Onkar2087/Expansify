...
function ViewCourse() {
  ...
  const handleReview = async () => {
    if (comment.trim().length < 5) {
      toast.error("please upload a suitable review");
      return;
    }
    try {
          ...
          <div className="flex-1 space-y-2 mt-[20px]">
            ...
            <div className="flex items-start flex-col justify-between">
              ...
              <div>
                ...
                <span className="line-through text-sm text-gray-400">{selectedCourseData?.price * 4 + 3}</span>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-white w-full md:w-2/5 p-6 rounded-2xl shadow-lg border border-gray-200">
            ...
            <p className="mt-4 text-center text-gray-500 italic">
              More lectures are on the way, till then keep learning!
            </p>
          </div>
