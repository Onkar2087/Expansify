    ...
    <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center flex-col gap-3'>
        <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e)=>e.preventDefault()}>
            <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3 '>
                ...
                <img src={logo} className="w-[70px] md:hidden rounded-lg" alt="" />
              ...
              {show && <MdRemoveRedEye className='absolute w-[20px] h-[20px] cursor-pointer right-[5%] bottom-[10%]' onClick={()=>setShow(prev => !prev)} />}
                ...
                <div className='w-[80%] flex items-center gap-2'>
                    ...
                    <div className='w-[25%] h-[0.5px] bg-[rgb(196,196,196)]'></div>
                </div>
                ...
                <div className='text-[#6f6f6f] cursor-pointer' onClick={()=>navigate("/login")}>
                    Already have an account? <span className='underline underline-offset-1 text-[black]'>Login</span></div>
            ...
            <span className='text-[white] text-2xl'>Expansify</span>
            </div>
